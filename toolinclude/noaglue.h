//This file contains some definitions of questionable legal status.
//Once their status has been properly assessed, illegal items will be
//removed and/or replaced. Please do not cause an uproar over the
